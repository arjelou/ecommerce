    ...
    return (
      <>
        ...
        <div className="container spring-sale-category">
            ...
            <div className="d-flex justify-content-md-center mt-5">
                <div md="4" lg="4" className="outwear">
                    <img alt="outwear" src={require('./assets/outerwear.png')} width={350} className="gap-1 filter-imager"/>
                    <h2 className="text-center bottom-center">Outerwear</h2>
                </div>
                <div md="4" lg="4" className="hoodies">
                <img alt="hoodies" src={require('./assets/hoodies.png')} width={350} className="mb-2"/>
                    <h2 className="text-center bottom-center">Hoodies</h2>
                </div>
                <div md="4" lg="4" className="footwear">
                <img alt="footwear" src={require('./assets/footwear.png')} width={350} className="mb-2"/>
        ...
        <div className="container best-sellers">
            ...
            <div className="d-flex justify-content-md-center">
                <div className="dresses">
                    <img alt="dresses" src={require('./assets/dresses.png')} width={350} className="mb-2"/>
                    <h2 className="text-center">Dresses</h2>
                </div>
                <div className="knitwear">
                <img alt="knitwear" src={require('./assets/knitwear.png')} width={350} className="mb-2"/>
                    <h2 className="text-center">Knitwear</h2>
                </div>
                <div className="crop_tops">
                <img alt="crop_tops" src={require('./assets/crop_tops.png')} width={350} className="mb-2"/>
        ...
        <div className="container-fluid physical-stores">
            <div>
                <div md="3" lg="5" className="physical-stores">
